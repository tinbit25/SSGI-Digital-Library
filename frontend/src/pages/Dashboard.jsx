...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      {/* Welcome Banner */}
      <div className="relative overflow-hidden rounded-3xl glass-panel p-8 border border-gray-200">
        <div className="absolute top-0 right-0 -mt-12 -mr-12 w-64 h-64 bg-gradient-to-br from-blue-100 via-indigo-50 to-transparent rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              to="/resources"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl ssgi-gradient-bg text-white font-semibold text-xs shadow-xl shadow-blue-500/15 hover:brightness-110 transition-all"
            >
              <Search size={16} />
            ...
            <Link
              to="/ai-assistant"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-indigo-50 border border-indigo-200 text-indigo-600 hover:bg-indigo-100 font-semibold text-xs transition-all"
            >
              <Bot size={16} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, i) => {
          ...
          return (
            <div key={i} className="glass-card p-5 rounded-2xl border border-gray-200 hover:border-gray-300 transition-all group">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className={`w-9 h-9 rounded-xl bg-gradient-to-tr ${stat.color} p-[1px]`}>
                  <div className="w-full h-full bg-gray-50 rounded-[11px] flex items-center justify-center text-slate-700">
                    <IconComp size={18} />
                  </div>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass-panel p-6 rounded-3xl border border-gray-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/resources" className="text-xs text-blue-600 hover:underline flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <Link
                  ...
                  className="p-4 rounded-2xl bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-blue-300 transition-all group block"
                >
                  <div className="flex justify-between items-start mb-1">
                    <h3 className="text-xs font-semibold text-slate-700 group-hover:text-blue-600 transition-colors">{cat.title}</h3>
                    <span className="text-[10px] font-medium text-slate-500 px-2 py-0.5 rounded-full bg-gray-100 border border-gray-300">{cat.count}</span>
                  </div>
          ...
          {(user?.role === ROLES.LIBRARIAN || user?.role === ROLES.ADMIN) && (
            <div className="glass-panel p-6 rounded-3xl border border-emerald-200 bg-emerald-50">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] text-emerald-600">Authorized Access</span>
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                <Link to="/resources" className="px-4 py-2 rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-200 text-xs font-medium hover:bg-emerald-100 transition-colors">
                  Upload & Categorize Documents
                </Link>
                <Link to="/feedback" className="px-4 py-2 rounded-xl bg-gray-100 text-slate-700 text-xs font-medium hover:bg-gray-200 transition-colors">
        ...
        <div className="space-y-6">
          <div className="glass-panel p-6 rounded-3xl border border-indigo-200 bg-gradient-to-b from-indigo-50 to-transparent relative overflow-hidden">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-2xl bg-indigo-50 border border-indigo-300 flex items-center justify-center text-indigo-600">
                <Bot size={22} />
              </div>
              <div>
                <h3 className="text-sm font-bold text-slate-800">AI Library Assistant</h3>
                <p className="text-[11px] text-indigo-600 font-medium">Powered by Qdrant RAG</p>
              </div>
            </div>
            ...
            <div className="space-y-2 mb-6">
              <div className="p-3 rounded-xl bg-gray-50 border border-gray-200 text-[11px] text-slate-500">
            ...
            <Link
              to="/ai-assistant"
              className="w-full py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs shadow-lg shadow-indigo-500/15 flex items-center justify-center gap-2 transition-all"
            >
              <Sparkles size={16} />
